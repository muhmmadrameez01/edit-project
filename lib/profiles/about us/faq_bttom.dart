...
class _FAQPageState extends State<FAQPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
           children: <Widget>[
         Image.asset('./assets/images/help signal.jpg',),
         Expanded(
          child: ListView(
        ...
        children: [
          ...
          FAQItem(
            question: 'How can I recognize the signs of domestic violence?',
            answer:
          ...
          FAQItem(
            question: 'Is it possible to break the cycle of domestic violence?',
            answer:
      ...
      print(index);
          ...
          if (index == 1) { // Check if the "InformationPage" icon is tapped (index 1).
            Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => InformationPage(),
            ));
          } else if (index == 2) { // Check if the "FAQ" icon is tapped (index 2).
            Navigator.of(context).push(MaterialPageRoute(
